...
<div class="wrapper-page">
    <div class=" card-box">
        <div class="panel-heading">
            <h3 class="text-center"> Sign Up to <strong class="text-custom">SMS Screen Management System</strong> </h3>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <?= '<p>Already have account?'. $this->Html->link('<b> Login </b>', ['controller'=>'users','action'=>'Login',], ['class'=>'text-primary m-l-5', 'escape'=>false]).'</p>' ?>
